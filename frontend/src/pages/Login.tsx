            ...
            <form onSubmit={handleAuth} className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {!isSignUp && (
                    <button 
                      ...
                      className="text-xs font-medium text-blue-400 hover:text-blue-300 transition-colors focus:outline-none focus:underline"
                    >
                      Forgot password?
                    </button>
                  )}
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-3 bg-[#13141a] text-slate-500 rounded-full">Or continue with</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-3 px-4 bg-white/5 hover:bg-white/10 text-slate-200 font-medium rounded-xl border border-white/10 flex items-center justify-center gap-3 transition-all duration-200 ease-out"
              >
